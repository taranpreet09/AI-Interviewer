    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {/* Fixed: Use categoryBreakdown instead of accuracyData */}
                {data.categoryBreakdown && data.categoryBreakdown.some(item => item.value > 0) ? (
                    <div className="bg-gray-800 p-6 rounded-lg lg:col-span-2 flex flex-col items-center">
                        <h2 className="text-xl font-semibold mb-4 text-white">Questions by Category</h2>
                        <ResponsiveContainer width="100%" height={300}>
                            <PieChart>
                                <Pie 
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg lg:col-span-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center">
                                <p className="text-2xl font-bold text-cyan-400">{data.summary.averageScore.toFixed(1)}/5.0</p>
                                <p className="text-sm text-gray-400">Average Score</p>
                            </div>
                            <div className="text-center">
                                <p className="text-2xl font-bold text-green-400">{data.summary.totalQuestions}</p>
                                <p className="text-sm text-gray-400">Total Questions</p>
                            </div>
                            <div className="text-center">
                                <p className="text-2xl font-bold text-purple-400">{data.summary.performanceLevel}</p>
